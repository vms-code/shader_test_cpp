...
#ifndef GRAPHICS_PERSPECTIVECAMERA_HPP
#define GRAPHICS_PERSPECTIVECAMERA_HPP
...
class PerspectiveCamera : public Camera {
   public:
    ...
    explicit PerspectiveCamera(float fov = 60, float aspect = 1, float near = 0.1, float far = 2000);
